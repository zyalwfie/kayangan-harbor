                        ...
                        <div class="single-destinations">
                            ...
                            <div class="details">
                                ...
                                <div class="d-flex flex-column">
                                    <button type="button" class="btn btn-secondary mb-2" disabled data-toggle="tooltip" data-placement="right" title="<?= $ticket->golonganKendaraan ? $ticket->deskripsiGolonganKendaraan : 'Tidak ada golongan kendaraan' ?>">
                                        <b><?= $ticket->golonganKendaraan ? $ticket->golonganKendaraan : 'Golongan 0' ?></b>
                                    </button>
                                    <?php if ($ticket->golonganKendaraan) : ?>
                                        <small><?= $ticket->deskripsiGolonganKendaraan ?></small>
                                    <?php else : ?>
                                        <small>Pejalan kaki</small>
                                    <?php endif; ?>
                                </div>
