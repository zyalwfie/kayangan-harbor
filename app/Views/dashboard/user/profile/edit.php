...
<form action="<?= route_to('dashboard.profile.update') ?>" class="row" method="post">
    <?= csrf_field() ?>
    <div class="col-lg-4">
        <div class="card pt-4">
                    ...
                    <?php for ($i = 1; $i <= 8; $i++) : ?>
                        <div class="col-3 input-container">
                            ...
                            <label for="<?= "avatar-$i" ?>" class="avatar-label">
                                <img src="<?= base_url('img/profile/') . "user-$i.svg" ?>" alt="Profile <?= $i ?>" style="width: 4rem; object-fit: cover;">
                            </label>
                        </div>
                    <?php endfor ?>
                </div>
